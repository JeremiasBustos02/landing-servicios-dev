    ...
    <section id="pricing" className="relative max-w-6xl mx-auto py-24 px-6">
      ...
      <div className="pricing-grid relative z-10 mt-12">
        {PLANS.map(plan => (
          <div
            key={plan.title}
            className={`liquid-glass rounded-2xl border border-white/10 p-6 flex flex-col gap-6 hover:-translate-y-2 transition-all duration-500 ${
          ...
          >
            ...
            <PrimaryButton label="Empezar proyecto" className="w-full justify-center" />
          </div>
        ))}
      </div>
    </section>
