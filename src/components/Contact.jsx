                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    <div className="flex flex-col gap-6 text-left">
                        ...
                        <div className="flex flex-col gap-4 mt-4">
                            ...
                            >
                                <svg fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6 text-gray-500">
                            ...
                            <a
                                ...
                                className="flex items-center justify-center gap-3 w-full p-4 rounded-xl bg-[#25D366] text-white font-semibold hover:bg-[#20bd5a] transition-colors shadow-sm hover:shadow-md"
                            >
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            ...
                            <div>
                                <label htmlFor="message" className="block text-sm font-medium text-gray-700 mb-1.5">¿En qué te puedo ayudar?</label>
